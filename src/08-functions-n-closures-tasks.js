...
function getPolynom(...args) {
  ...
  if (args.length === 2) {
    return (param) => param * args[0] + args[1];
  }
  if (args.length === 3) {
    return (param) => args[0] * param ** 2 + args[1] * param + args[2];
  }
  return null;
}
...
function partialUsingArguments(fn, ...args1) {
  const firstArrOfArguments = args1;
  return (...args2) => fn(...firstArrOfArguments, ...args2);
}
