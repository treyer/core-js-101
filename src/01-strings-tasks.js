...
function getRectangleString(width, height) {
  ...
  for (let i = 0; i < height; i += 1) {
    for (let j = 0; j < width; j += 1) {
      ...
      if (i === 0 && j !== 0 && j !== width - 1) result += horizontalLine;
      if (i === height - 1 && j !== 0 && j !== width - 1) result += horizontalLine;
      if (j === 0 && i !== 0 && i !== height - 1) result += verticalLine;
      if (j === width - 1 && i !== 0 && i !== height - 1) result += verticalLine;
      if (i !== 0 && i !== height - 1 && j !== 0 && j !== width - 1) result += ' ';
    }
    result += '\n';
  }
